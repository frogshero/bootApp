...
public class ClientCnxnSocketNIO extends ClientCnxnSocket {
    ...
    void doIO(List<Packet> pendingQueue, ClientCnxn cnxn)
      throws InterruptedException, IOException {
        ...
        if (sockKey.isReadable()) {
            ...
            /**
             * @@apiNote hasRemaining=true表示还没有读完数据
             */
            if (!incomingBuffer.hasRemaining()) {
                ...
                if (incomingBuffer == lenBuffer) {
                    ...
                    enableRead();
                    /**
                     * @@apiNote 读取在ClientCnxn.submitRequest加入的Packet
                     */
                ...
                if (!p.bb.hasRemaining()) {
                    ...
                    if (p.requestHeader != null
                        ...
                        synchronized (pendingQueue) {
                            /**
                             * @@apiNote 在上面客户端调用sendThread.readResponse读完返回结果后会删除
                             */
                            pendingQueue.add(p);
                        }
                    }
    ...
    throws IOException {
        ...
        /**@@apiNote
         * If this channel is in non-blocking mode then an invocation of this method initiates a non-blocking connection
         * operation.  If the connection is established immediately, as can happen with a local connection, then this
         * method returns true.  Otherwise this method returns false and the connection operation must later
         * be completed by invoking the finishConnect method.
         * 在doTransport里会再次检查连接情况，调用finishConnect
         */
    ...
    /**
     * @@apiNote
     * SelectionKey的注释：The interest set determines which operation categories will be tested for readiness the next time
